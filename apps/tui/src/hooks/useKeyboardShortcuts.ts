...
const panes: readonly PaneId[] = ["home", "chat", "plan", "plan_library", "run", "repository", "output", "artifact_json", "pack_builder", "capabilities", "approvals", "doctor", "help", "timeline", "tasks", "diff", "verification", "review", "research", "demo"];

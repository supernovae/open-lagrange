...
const showcase = [
  ...
  },
  {
    ...
    body: "Open Lagrange complements Synesis by turning agentic work into typed plans, continuation boundaries, artifacts, repository diffs, and explicit human decisions.",
  },
];

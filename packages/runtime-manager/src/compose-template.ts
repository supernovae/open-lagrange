...
services:
  ...
  open-lagrange-api:
    ...
    environment:
      ...
      OPEN_LAGRANGE_SEARCH_PROVIDER: \${OPEN_LAGRANGE_SEARCH_PROVIDER:-}
      OPEN_LAGRANGE_SEARCH_KIND: \${OPEN_LAGRANGE_SEARCH_KIND:-}
      OPEN_LAGRANGE_SEARCH_BASE_URL: \${OPEN_LAGRANGE_SEARCH_BASE_URL:-}
